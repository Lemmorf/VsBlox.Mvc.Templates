...
namespace VsBlox.Mvc.Templates.JsObjectFor
{
  ...
  /// </summary>
  public class Builder1<T> : IHideObjectMembers, IHtmlString
  {
    private readonly HtmlHelper _html;
    private readonly JsObjectBuilder _objectBuilder = new JsObjectBuilder();

    /// <summary>
    /// Initializes a new instance of the <see cref="Builder1{T}"/> class.
    /// </summary>
    ...
    public Builder1(HtmlHelper html, bool asObject, bool lowercaseNames = false, string namePrefix = "")
    {
      _html = html;
    ...
    {
      _objectBuilder.AddProperties(typeof(T));
