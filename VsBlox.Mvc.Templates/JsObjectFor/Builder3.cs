...
namespace VsBlox.Mvc.Templates.JsObjectFor
{
  ...
  /// </summary>
  public class Builder3<T1, T2, T3> : IHideObjectMembers, IHtmlString
  {
    private readonly HtmlHelper _html;
    private readonly JsObjectBuilder _objectBuilder = new JsObjectBuilder();

    /// <summary>
    /// Initializes a new instance of the <see cref="Builder3{T1, T2, T3}"/> class.
    /// </summary>
    ...
    public Builder3(HtmlHelper html, bool asObject,  bool lowercaseNames = false, string namePrefix = "")
    {
      _html = html;
