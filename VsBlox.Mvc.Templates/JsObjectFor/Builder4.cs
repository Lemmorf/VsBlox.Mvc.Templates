...
namespace VsBlox.Mvc.Templates.JsObjectFor
{
  ...
  /// </summary>
  public class Builder4<T1, T2, T3, T4> : IHideObjectMembers, IHtmlString
  {
    private readonly HtmlHelper _html;
    private readonly JsObjectBuilder _objectBuilder = new JsObjectBuilder();

    /// <summary>
    /// Initializes a new instance of the <see cref="Builder4{T1, T2, T3, T4}"/> class.
    /// </summary>
    ...
    public Builder4(HtmlHelper html, bool asObject, bool lowercaseNames = false, string namePrefix = "")
    {
      _html = html;
