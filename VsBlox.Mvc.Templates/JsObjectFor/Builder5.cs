...
namespace VsBlox.Mvc.Templates.JsObjectFor
{
  ...
  /// </summary>
  public class Builder5<T1, T2, T3, T4, T5> : IHideObjectMembers, IHtmlString
  {
    private readonly HtmlHelper _html;
    private readonly JsObjectBuilder _objectBuilder = new JsObjectBuilder();

    /// <summary>
    /// Initializes a new instance of the <see cref="Builder5{T1, T2, T3, T4, T5}"/> class.
    /// </summary>
    ...
    public Builder5(HtmlHelper html, bool asObject, bool lowercaseNames = false, string namePrefix = "")
    {
      _html = html;
